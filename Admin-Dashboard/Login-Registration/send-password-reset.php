                            ...
                            <tr>
                                <td align="left" style="padding: 20px;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 20px 0;">
                                        <tr>
                                            <td width="30%" style="padding: 10px 0; color: #333333; font-weight: bold;">Admin Passwrod reset link:</td>
                                            <td width="70%" style="padding: 10px 0; color: #333333;">Click <a href="https://fpdentalclinic.com/Admin-Dashboard/Login-Registration/reset-password.php?token=$token">here</a>
