...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($validateUser && $_POST["lPass"] === $validateUser["Password"]) {
        ...
        if ($validateUser["Access_Level"] == 2) {
            ...
            header("Location: ../Doctor-Section/");
            exit;
        }elseif ($validateUser["Access_Level"] == 3) {
            $_SESSION["validAdmin"] = 3;
            // Redirect for Access_Level 1 (Doctor)
...
<body class="img js-fullheight" style="background-image: url(bg.svg);">
                    ...
                    <div class="login-wrap p-4 p-md-5 bg-dark-subtle rounded-3 shadow-lg">
                        ...
                        <form class="signin-form" method="post">
                            ...
                            <div class="form-group mb-4 position-relative">
                                <input class="form-control form-control-lg" type="password" id="lPass" name="lPass"
                                    placeholder="Password">
                            </div>

                            <div class="form-group mb-4">
                                <button type="submit" id="submit" name="submit" class="btn btn-primary w-100 py-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="forgot-password-page.php" id="btnForgot"
                                    class="text-light text-decoration-none">Recover account (Admin)</a>
