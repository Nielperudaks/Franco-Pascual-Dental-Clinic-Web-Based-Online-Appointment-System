...
<head>
    ...
    $(document).ready(function() {
        ...
        function filterTransactions() {
            ...
            console.log('<?php echo $validateUser["Username"] ?>');
            $.ajax({
                url: 'filter-transactions.php',
                method: 'POST',
                data: {
                    status: selectedStatus,
                    doctorID: '<?php echo $validateUser["Username"] ?>'
                },
                success: function(response) {
                    try {
                        ...
                        $('#status-selector').change(filterTransactions);
                                ...
                                <div class="card-body">
                                    <div class="filter-section mb-3">
                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                            <select class="form-select" style="max-width: 200px" id="status-selector">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-secondary" id="confirmBtn2">Confirm</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-secondary" id="confirmBtn3">Confirm</button>
                                </div>
                            </div>
                        </div>
                    </div>
