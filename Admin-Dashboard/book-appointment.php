...
<head>
    ...
    $(document).ready(function() {
        ...
        $("#datatable").on("click", ".followup-btn", function() {
            $('#myModal').modal('hide');
            console.log(appointmentTime);
            Swal.fire({
                title: 'Is Appointment fee paid?',
                icon: 'question',
                ...
                if (result.isDenied) {
                    Swal.fire({
                        ...
                        text: 'The appointment process has been cancelled.',
                        icon: 'info',
                        confirmButtonText: 'Okay'
                    });
                } else {
                    // Set priority based on user's response
                    var isPriority = result.isConfirmed ? "Yes" : "No";
                    // Proceed with appointment creation if fee is paid
                    ...
                    if (originalDate !== rdate) {
                        Swal.fire({
                            title: 'Date Modified',
                            text: 'Warning: Selected date has been modified!',
                            icon: 'warning',
                            confirmButtonText: 'Okay'
                        });
                        location.reload();
                    ...
                    $.ajax({
                        ...
                        error: function(xhr, status, error) {
                            ...
                            Swal.fire({
                                title: 'Error',
                                text: 'An error occurred while trying to store the data in the database.',
                                icon: 'error',
                                confirmButtonText: 'Okay'
                            });
                        }
                                ...
                                <div class="card-body d-flex">
                                    <div class="align-self-center w-100">
                                        <div class="mb-3" id="timeslots">
                                            <?php include 'fetch-time-slots.php'; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
