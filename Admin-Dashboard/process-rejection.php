                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; background-color: #ffffff; margin-top: 50px;">
                            ...
                            <tr>
                                <td align="left" style="padding: 20px;">
                                    <h2 style="color: #333333; margin: 0;">Appointment Rejection</h2>
                                    <p style="color: #333333; font-size: 16px;">
                                       We would like to inform you that your appointment has been rejected. Below are the details of the rejection:
                                    </p>
