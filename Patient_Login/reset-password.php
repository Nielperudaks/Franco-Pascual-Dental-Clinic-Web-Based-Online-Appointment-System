...
<head>
    ...
    <script src="https://unpkg.com/just-validate@latest/dist/just-validate.production.min.js" defer></script>
    <script src="scripts/forgot-validation.js" defer></script>
    <script>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-8 col-lg-5">
                    <div class="login-wrap p-4 p-md-5 bg-dark-subtle rounded-3 shadow-lg">
                        ...
                        <form class="form" id="a-form" method="post" action="password-reset-process.php"
                            novalidate="novalidate">
                            <input type="hidden" name="token" value="<?=htmlspecialchars($token)?>">     
                            <div class="form-group mb-4 position-relative">
                                <input class="form-control form-control-lg" type="password" placeholder="New Password" name="password" id="password">
                            </div>
                            <div class="form-group mb-4 position-relative">
                                <input class="form-control form-control-lg" type="password" placeholder="Re-Enter Password" name="rPassword" id="rPassword">
                            </div>
                            <div class="form-group mb-4">
                                <button type="submit" id="reset" class="btn btn-primary w-100 py-3">
